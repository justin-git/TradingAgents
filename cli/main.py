...
def get_user_selections():
    ...
    selected_shallow_thinker = select_shallow_thinking_agent(selected_llm_provider, backend_url=backend_url)
    selected_deep_thinker = select_deep_thinking_agent(selected_llm_provider, backend_url=backend_url)
